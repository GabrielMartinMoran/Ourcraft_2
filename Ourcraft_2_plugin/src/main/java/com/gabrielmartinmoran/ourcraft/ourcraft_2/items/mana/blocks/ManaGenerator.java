...
public class ManaGenerator extends CustomItem {

    @Override
    public ItemStack getItem() {
        ItemStack item = new ItemStack(Material.FURNACE, 1);
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName("Generador de maná");
        meta.setCustomModelData(CustomItemsModelData.MANA_GENERATOR.getModelData());
    ...
    public Recipe getRecipe() {
        NamespacedKey nsKey = new NamespacedKey(JavaPlugin.getPlugin(Main.class), "mana_generator");
