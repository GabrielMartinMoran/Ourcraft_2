...
public class SupremeManaPotion extends BaseManaPotion {

    @Override
    public Recipe getRecipe() {
        NamespacedKey nsKey = new NamespacedKey(JavaPlugin.getPlugin(Main.class),"supreme_mana_potion");
        ...
        for (int i = 0; i < 4; i++) recipe.addIngredient(manaEssence);
        return recipe;
    }

    @Override
    protected String getName() {
        return "Poción de maná suprema";
    }
