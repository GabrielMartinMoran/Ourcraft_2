...
public class DistanceTablet extends CustomItem {
    @Override
    public ItemStack getItem() {
        ItemStack item = new ItemStack(Material.CARROT_ON_A_STICK, 1);
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName("Tablilla de distancia");
        meta.setLore(Arrays.asList("Aumenta el consumo de maná pero también el alcance"));
        meta.setCustomModelData(CustomItemsModelData.DISTANCE_TABLET.getModelData());
    ...
    public Recipe getRecipe() {
        NamespacedKey nsKey = new NamespacedKey(JavaPlugin.getPlugin(Main.class), "distance_tablet");
